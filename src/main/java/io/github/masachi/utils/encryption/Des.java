...
public class Des implements IEncryption {
    private String firstKey = "masachi";
    private String secondKey = "cv3sarato";
    private String thirdKey = "ga";
    ...
    public String encode(String data) {
        ...
        String firstKey = "", secondKey = "", thirdKey = "", suffix = "";
        if (leng > 0) {
            firstKey = getKey(data);
            secondKey = getKey(data);
            thirdKey = getKey(data);
            suffix = firstKey + secondKey + thirdKey;
        }
        ...
        if (leng > 0) {
            if (leng < 4) {
                int[] bt = strToBt(data);
                int[] encByte = null;
                if (!firstKey.equals("") && !secondKey.equals("") && !thirdKey.equals("")) {
                    int[] tempBt;
                    int x, y, z;
                    tempBt = bt;
    ...
    public String decode(String data) {
        ...
        if (leng > 0) {
            String s = data.substring(leng - 3, leng);
            firstKey = String.valueOf(s.charAt(0));
            secondKey = String.valueOf(s.charAt(1));
            thirdKey = String.valueOf(s.charAt(2));
            data = data.substring(0, leng - 3);
        }
    ...
    private String getKey(String data) {
        int number = new BigDecimal(10 * Math.random()).setScale(0, BigDecimal.ROUND_DOWN).intValue();
        int index = new BigDecimal((data.length() - 1) * number / 10 + "").setScale(0, BigDecimal.ROUND_DOWN).intValue();
