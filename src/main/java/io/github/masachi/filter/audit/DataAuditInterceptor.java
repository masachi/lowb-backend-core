...
public class DataAuditInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        log.info("[DataAuditInterceptor][preHandle]start");
        ...
        if (userInfo == null) {
            log.info("[DataAuditInterceptor][preHandle] userInfo is null");
            return true;
        } else {
            log.info("[DataAuditInterceptor][preHandle] userInfo :{}", userInfo);
        }
